...
静心木鱼 V2.1 的三工具练习、真实记录、设置和本地合规页面已完成。项目本地与外部标准门禁、debug/release/ohosTest 构建和设备 Hypium 43/43 均通过；phone 模拟器已完成练习、记录、设置、二级合规页面、弹层校验和清除确认交互验证。应用仅申请振动权限，无网络权限、广告 SDK、广告位、登录、支付或云同步。
